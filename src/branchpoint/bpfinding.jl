function BPFinding!(f!, g, x::Array{U, 1}, params, v::Array{U, 1}, 
...
function BPFinding!(f!, bc!, g, x::Array{U, 1}, params, v::Array{U, 1}, 
                    q::Array{U, 1}, J::Array{U, 2}, F::Array{U, 1}, 
                    dxeval::Array{U, 1}, Jeval::Array{U, 2},
                    dy::Array{TaylorN{U}, 1}, yaux::Array{TaylorN{U},1}, 
                    ite::T, tol::U, ordtup::Array{NTuple{N, T}, 2}, n::T) where {U<:Real, T<:Integer, N}
    ...
    if norm(F) > tol
        @warn("The branch point tolerance was exceded; norm = $(norm(F))")
    end 
